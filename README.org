...
- Weds Sep 23: [[https://cloud.r-project.org/web/packages/dirichletprocess/vignettes/dirichletprocess.pdf][R package dirichletprocess vignette]], Murphy figures
  [[file:Murphy.figure.25.2.finite.png][finite]], [[file:Murphy.figure.25.6.infinite.png][infinite]] mixture models.
