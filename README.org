...
- Weds Sep 23: [[http://www.cs.columbia.edu/~blei/papers/Blei2012.pdf][Comm ACM Intro to Topic Models]] (Blei LDA), [[https://cran.r-project.org/web/packages/topicmodels/vignettes/topicmodels.pdf][R package
  topicmodels vignette]].
- Fri Sep 25: [[https://cloud.r-project.org/web/packages/dirichletprocess/vignettes/dirichletprocess.pdf][R package dirichletprocess vignette]]
- HMM MLAPP-17.5.2
...
UPDATE Thurs Sept 10: [[https://docs.google.com/document/d/1W6-HdQLgHayOFXaQtscO5J5yf05G7E6KeXyiBJFcT7A/edit?usp=sharing][This rubric]] will be used to grade the code
...
- 7: Dirichlet and Chinese Restaurant Process Due Fri Sep 25, 11:59PM.
